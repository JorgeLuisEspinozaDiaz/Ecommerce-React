...
const ProductDescription = ({ product }) => {
  ...
  //   const previos = () => {
  //     const condition = position > 0;
  //     const nextPosition = condition ? position - 1 : images.length - 1;
  //     selectedImage(images[nextPosition]);
  //     setPosition(nextPosition);
  //   };

  //   const next = () => {
  //     const condition = setPosition < images.length;
  //     const nextPosition = condition ? position + 1 : 0;
  //     selectedImage(images[nextPosition]);
  //     setPosition(nextPosition);
  //   };
